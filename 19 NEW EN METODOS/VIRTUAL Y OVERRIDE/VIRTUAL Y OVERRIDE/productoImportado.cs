...
namespace VIRTUAL_Y_OVERRIDE
{
    class productoImportado : Productocs
    {
        ...
        public new void muestraVemta()
        {
            //HACEMOS NEW DEL METODO HEREDADO NO VIRTUAL DE PRODUCTO
            Console.WriteLine("el producto {0} se vende en {1}", descripcion, precioVenta);
        }
    }
}
